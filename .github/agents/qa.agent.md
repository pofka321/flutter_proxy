...
5. Run `flutter test` after writing — report pass/fail count and any failures with full output
6. If a test fails due to a bug in production code, report it clearly and stop — do not fix production code yourself
